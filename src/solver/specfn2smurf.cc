...
ITE_INLINE void ConstructLemmasForLongXorEquals(SpecialFunc *pSpecialFunc);
ITE_INLINE void ConstructLemmasForLongAndEquals(SpecialFunc *pSpecialFunc);


ITE_INLINE
void
SpecFn2Smurf (BDDNodeStruct *pFunc,
      int nFunctionType,
      int nEqualityVble,
      ...
      )
{
   ...
   switch (nFunctionType) {
    ...
    case PLAINXOR:
       ...
       ConstructLemmasForLongXorEquals(pSpecialFunc);
       break;
    default:
       break;
   }

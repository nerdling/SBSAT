...
{ &PLAINOR_LIMIT, "", "limit-or", P_INT, V(i:0,"0"), V(i:8,"8"), VAR_NORMAL, 0, 
                "The minimum # of literals to flag special function plainor"},
{ &PLAINXOR_LIMIT, "", "limit-xor", P_INT, V(i:0,"0"), V(i:5,"5"), VAR_NORMAL, 0,
                "The minimum # of literals to flag special function plainxor"},*/
{ &preproc_uses_limits, "pl", "preproc-uses-limits", P_INT, V(i:0,"0"), V(i:1,"1"), VAR_NORMAL, 0, 
...
{ &formatout, "b", "", P_PRE_CHAR, V(c:'b',"b"), V(c:'b',"b"), VAR_NORMAL, 0, 
                "Start SMURF solver"},
{ &formatout, "d", "", P_PRE_CHAR, V(c:'d',"d"), V(c:'b',"b"), VAR_NORMAL, 0, 

  ...
  switch (yyn)
    {
        case 4:
#line 50 "aig_g.yy"
    { aig_inputs = (yyvsp[(3) - (7)].num);
	  aig_latches = (yyvsp[(4) - (7)].num);
	  aig_outputs = (yyvsp[(5) - (7)].num);
	  aig_ands = (yyvsp[(6) - (7)].num);
	  d2_printf6("header! %d %d %d %d %d\n",(yyvsp[(2) - (7)].num),(yyvsp[(3) - (7)].num),(yyvsp[(4) - (7)].num),(yyvsp[(5) - (7)].num),(yyvsp[(6) - (7)].num));
	  if(aig_latches > 0){
...
#line 110 "aig_g.yy"
    { 
  aig_array[aig_index++] = (yyvsp[(1) - (2)].num);
  /*d2_printf2("\t %d\n",$1);*/
}
    break;

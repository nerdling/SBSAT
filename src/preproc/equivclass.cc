...
class Linear {
 ...
 public:
   */
   ...
   Linear::Linear(int inp, int True, int False) {
   ...
   //
	...
	Result *Linear::insertEquiv (int x, int y) {
   ...
   Result *Linear::insertOppos (int x, int y) {
   ...
   int Linear::isEquiv (int x, int y) {
      int a, b;
   ...
   int *Linear::valueOfTrue ()  { return equivalent(Tr); }
   int *Linear::valueOfFalse () { return equivalent(Fa); }
   
   // Returns the number of other variables equivalent to x 
   int Linear::equivCount (int x) {
      int a;
      for (a=x ; equiv_fwd[a] >= 0 ; a=equiv_fwd[a]);
   ...
   void Linear::printEquivalence (int x) {
      int a;
      for (a=x ; equiv_fwd[a] >= 0 ; a=equiv_fwd[a]);
   ...
   void Linear::printOpposite (int x) {
      int a;
      for (a=x ; equiv_fwd[a] >= 0 ; a=equiv_fwd[a]);
   ...
   void Linear::printNoLinksToRoot () {
      cout << "Links: ";
      for (int i=0 ; i < no_inp_vars ; i++) {
			int j=0;
   ...
   void Linear::printEquivClassCounts () {
      cout << "EqCnt (Var:cnt): ";
      for (int i=0 ; i < no_inp_vars ; i++) {
			if (equiv_fwd[i] < 0) {
				cout << i << ":" << equiv_cnt[i] << " ";
   ...
   void Linear::printEquivVarCount () {
   ...
   void Linear::printOpposVarCount () {

...
{
   int nNumRHSVbles = arrSolverFunctions[nFnId].fn_xor.rhsVbles.nNumElts;
   int *arrRHSVbles = arrSolverFunctions[nFnId].fn_xor.rhsVbles.arrElts;
   ...
   arrSolverFunctions[nFnId].fn_xor.pLongLemma = pFirstBlock;
